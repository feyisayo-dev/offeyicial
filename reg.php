            ...
            <fieldset>
                ...
                <form>
                    <div class="form-group">
                        ...
                        <button class="container" type="button" id="show-password-button" onclick="showPassword()"> Show </button>
                    ...
                    <div class="form-group">
                        ...
                        <button class="container" type="button" id="show-Confirmpassword-button" onclick="showConfirmpassword()"> Show </button>
